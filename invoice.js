...
//             <td><input type="number" class="form-control unitPrice" placeholder="Enter Description" required></td>
//             <td><input type="text" class="form-control totalItem" disabled randomly></td>
//             <td><input type="button" class="btn  btn-danger" onclick="removeInvoiceItem(${itemCounter})">Remove</button></td>
//         </tr>
//     `;
...
function addInvoiceItem() {
    ...
    const newItemRow = `
        <tr id="itemRow${itemCounter}">
            ...
            <td><input type="text" class="form-control totalItemPrice" readonly></td>
...
$("#invoiceForm").submit(async function (event) {
    event.preventDefault();
    updateTotalAmount();
    ...
    const totalAmount = $("#totalAmount").val();
    const invoiceData = { customerName, invoiceDate, items, totalAmount };
    ...
    alert('Invoice generated and stored successfully!');
});
